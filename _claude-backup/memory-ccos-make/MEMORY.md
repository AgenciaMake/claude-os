...
- [Autorização de modelo por senha](feedback_autorizacao_modelo.md) — senha na mensagem libera Opus/Fable via Bash; fluxo: liberar → executar → restringir automático
